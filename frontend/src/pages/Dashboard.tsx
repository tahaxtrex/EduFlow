            ...
            <div className="max-w-7xl mx-auto">
                ...
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-12">
                    ...
                    <div className="flex gap-4 w-full md:w-auto">
                        <Link
                            to="/"
                            className="flex-1 md:flex-none flex justify-center items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 rounded-lg transition font-medium"
                        >
                            <Plus className="w-4 h-4" /> New Course
                        </Link>
                        <button
                            onClick={handleSignOut}
                            className="flex-1 md:flex-none flex justify-center items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg transition text-slate-300"
                        >
