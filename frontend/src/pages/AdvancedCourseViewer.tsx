                                    ...
                                    <div className="text-slate-300 leading-relaxed print:text-black">
                                        <ReactMarkdown
                                            ...
                                            components={{
                                                ...
                                                thead: ({ node, ...props }) => (
                                                    <thead className="bg-slate-900/50 text-purple-300" {...props} />
                                                ),
                                                tbody: ({ node, ...props }) => (
                                                ...
                                                blockquote: ({ node, ...props }) => (
                                                    <blockquote className="border-l-4 border-purple-500 pl-4 py-1 my-4 italic text-slate-400 bg-slate-800/30 rounded-r-lg" {...props} />
                                                )
                                            }}
                                        >
